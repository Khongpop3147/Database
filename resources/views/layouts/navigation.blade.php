<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    @php
        $cartCount = auth()->check() ? optional(auth()->user()->cart)->totalQuantity() : 0;
    @endphp
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-10 sm:space-x-8">
                    ...
                    @auth
                        <x-nav-link :href="route('cart.index')" :active="request()->routeIs('cart.*')">
                            {{ __('Cart') }}
                            @if($cartCount > 0)
                                <span class="ml-2 inline-flex items-center justify-center rounded-full text-xs px-2 py-0.5 bg-green-600 text-white">
                                    {{ $cartCount }}
                                </span>
                            @endif
                        </x-nav-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    <div class="space-x-2">
                        ...
                        <a href="{{ route('register') }}" class="text-sm text-blue-600 dark:text-blue-400 hover:underline">
                            {{ __('Register') }}
                        </a>
                    </div>
                @endauth
